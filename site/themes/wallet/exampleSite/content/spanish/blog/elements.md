---
title: "Elementos que puede utilizar para crear una nueva publicación en esta plantilla."
...
Aquí hay un ejemplo de coberturas. Puede usar este encabezado siguiendo las reglas de markdownify. Por ejemplo: use `#` para el título 1 y use `######` para el título 6.
